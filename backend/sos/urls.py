...
from .views import (
    ...
    AdminReportingView,
    AdminReportingExportExcelView,
    AdminReportingExportPdfView,
...
urlpatterns = [
    ...
    path("reporting/export/excel/", AdminReportingExportExcelView.as_view()),
    path("reporting/export/pdf/", AdminReportingExportPdfView.as_view()),
    path("reporting/", AdminReportingView.as_view()),
